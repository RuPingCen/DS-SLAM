...
do
	...
	do
		...
		sleep 1
		mv CameraTrajectory.txt  result/LK_ORBSLAM2_CameraTrajectory_KITTI_${sequence}_${times_k}.txt
		mv trackingtime.txt result/LK_ORBSLAM2_trackingtime_KITTI_${sequence}_${times_k}.txt
