...
class MSCKF {
  public:
    ...
    typedef boost::shared_ptr<MSCKF> Ptr;
    typedef boost::shared_ptr<const MSCKF> ConstPtr;
...
typedef MSCKF::Ptr MSCKFPtr;
typedef MSCKF::ConstPtr MSCKFConstPtr;
